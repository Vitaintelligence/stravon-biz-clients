        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {projects.map((project, index) => (
            <a
              ...
              className="portfolio-card group relative overflow-hidden border border-white/20 bg-black hover:bg-black transition-all duration-300 cursor-pointer"
            >
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {project.tech.map((tech, i) => (
                    <span
                      key={i}
                      className="px-2 py-1 border border-white/20 bg-black text-white text-xs font-medium"
                    >
                      {tech}
                    </span>
                  ))}
